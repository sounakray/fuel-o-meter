...
public class FormSetup extends AbstractFuelOMeterScreen {
	...
	final Form form;
	private final Command cmdMainMenu = new Command("Back", "Main Menu",
			Command.BACK, 0);
	...
	public FormSetup(final FuelOMeter midlet) {
		...
		ChoiceGroup chcUnit = new ChoiceGroup("Select Unit",
				ChoiceGroup.EXCLUSIVE, strUnits, null);
	 ...
	 * 
	 * @see
	 * sounakray.fuelometer.forms.AbstractFuelOMeterScreen#executeCommand(javax
